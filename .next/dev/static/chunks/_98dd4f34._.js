    ...
    const filteredPatients = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PatientsPage.useMemo[filteredPatients]": ()=>{
            return patients.filter({
                "PatientsPage.useMemo[filteredPatients]": (patient)=>patient.name.toLowerCase().includes(searchTerm.toLowerCase()) || patient.email.toLowerCase().includes(searchTerm.toLowerCase()) || patient.condition.toLowerCase().includes(searchTerm.toLowerCase())
            }["PatientsPage.useMemo[filteredPatients]"]);
        }
    }["PatientsPage.useMemo[filteredPatients]"], [
        patients,
...
_s(PatientsPage, "kfK6wkGLg99SOLfRKcTBcpL3wHg=");
_c = PatientsPage;
var _c;
...
//# sourceMappingURL=_98dd4f34._.js.map